...
An implementation of the [cut matching game](https://people.eecs.berkeley.edu/~vazirani/pubs/partitioning.pdf). Put simply,given an $\phi$ and a graph, the goal is to either find a $1/\phi$-cut in the graph or certify it as a $\phi$-expander (no $1/\phi$-cut exists). 
